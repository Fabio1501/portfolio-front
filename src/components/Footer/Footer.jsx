                            ...
                            <ul class="flex flex-wrap items-center ml-24 mb-6 sm:mb-0">
                                {
                                    staticComponents.footer.sections.map((section, index) => {
                                        if (index % 2 !== 0) {
                                            return(
                                                <li>
                                                    <a href={section.url.href} className="pl-6 pr-6 text-l text-white hover:underline md:pr-6 md:pl-6 border-x-2">{section.text.content}</a>
                                                </li>
                                            )
                                        }
                                        return(
                                        <li>
                                            <a href={section.url.href} className="ml-6 text-l text-white hover:underline md:mr-6">{section.text.content}</a>
                                        </li>
                                    )})
                                }
                            </ul>
