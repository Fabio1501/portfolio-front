...
const CardProyectos = ({grid, proy}) => {
    let btnStyle = 'appearance-none bg-green-600 border border-white rounded-lg text-white cursor-pointer inline-block font-semibold py-2 px-3 focus:outline-none focus:shadow-outline-green hover:bg-green-700 focus:bg-green-400 active:bg-green-700 disabled:bg-gray-400 disabled:text-gray-800 disabled:cursor-not-allowed'

    return (
        <section key={proy.image.id} className={`group ${grid} border-b-2 border-white rounded-lg`}>
